...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://autofilter:bg3fenKSzsvibEMM@autofilter.i1riqhu.mongodb.net/?retryWrites=true&w=majority&appName=autofilter")
